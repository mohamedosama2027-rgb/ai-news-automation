...
- Pexels API key
- Facebook Page ID
- Facebook Page access token بصلاحية نشر المحتوى
...
| `FACEBOOK_PAGE_ACCESS_TOKEN` | نعم | Token النشر للصفحة |
...
- `data/published-news.json` هو سجل الحالة الوحيد الذي يجب حفظه بين التشغيلات.
