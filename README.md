...
أداة Node.js لجمع أخبار الذكاء الاصطناعي والتكنولوجيا والروبوتات من Google News RSS مع Bing News كبديل، ثم تنقية الأخبار ودمج القصص المتكررة واختيار مجموعة متنوعة من المقالات. يستخدم Gemini لكتابة منشورات Facebook باللغة المصرية وإنشاء استعلامات للصور، ثم يستخدم Pexels لاختيار صورة تحريرية مناسبة وينشر النتيجة على Facebook Page.

## ماذا يفعل المشروع؟

1. يجلب أخبار التطور التقني في الصحة والعلوم والصناعة والنقل والطيران والطاقة والمناخ والزراعة والمال والتعليم والحكومة والبناء والسفر وتكنولوجيا المستهلك وغيرها.
...
7. يبحث في Pexels ويقيّم الصور عبر Gemini.
...
يعمل `daily.yml` يوميًا في الساعة 10 صباحًا و5 عصرًا و10 مساءً بتوقيت مصر الصيفي. أما `automation.yml` فهو للتشغيل اليدوي فقط حتى لا تتكرر المنشورات.
