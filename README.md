...
أداة Node.js تجمع أخبار الذكاء الاصطناعي والتكنولوجيا والروبوتات من Google News وBing، وتكتشف أدوات AI المجانية أو مفتوحة المصدر من Product Hunt. تنقح المحتوى وتمنع التكرار، ثم يستخدم Gemini لكتابة منشورات Facebook باللهجة المصرية مع رابط مباشر للأداة. تستخدم منشورات الأدوات صورا فريدة من Pexels؛ وتستخدم الأخبار صور Pexels افتراضيًا، مع خيارات توليد الصور عبر Gemini أو مقارنتها بعد تفعيل الفوترة.
...
7. يستخدم صور Pexels فريدة لمنشورات الأدوات. يستبعد النظام معرّفات الصور وروابطها المستخدمة سابقًا بين منشورات الأخبار والأدوات.
...
يكتشف Product Hunt الأدوات، ويوفر Pexels صورها. يفحص النظام سجل المنشورات لتجنب معرّف الصورة أو رابطها إذا استُخدم من قبل، ويجرب صفحة Pexels ثانية عند الحاجة. إذا لم تتوفر صورة Pexels جديدة، يتخطى المنشور بدل إعادة استخدام صورة.

يمنع سجل `data/published-news.json` تكرار الأداة المنشورة باستخدام اسمها بعد توحيده ورابطها وسجل Product Hunt. كل تشغيل يومي ينشر منشورًا واحدًا؛ إذا لم تتوفر صورة Pexels جديدة، يتخطى النظام المنشور بدل تكرار صورة.
